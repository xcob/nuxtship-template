<template>
    <div
      class="mx-auto max-w-5xl columns-2"
    >
    <div
      class="bg-black px-20 py-20 mx-auto max-w-5xl rounded-lg flex flex-col items-center text-center"
    >
    ...
    <div
      class="px-20 py-20 mt-20 mx-auto max-w-5xl rounded-lg flex flex-col items-center text-center"
    >
    <img
            class=""
