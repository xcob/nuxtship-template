      ...
      <ul class="items-center w-full text-sm font-medium text-gray-900 bg-white border  focus:ring-4 ring-gray-100  rounded-lg sm:flex ">
        <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r ">
            <div class="flex items-center ps-3">
                <input id="vue-checkbox-list" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100  border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 ">
        ...
        <li class="w-full border-b  sm:border-b-0 sm:border-r ">
            <div class="flex items-center ps-3">
                ...
                <label for="react-checkbox-list" class="w-full py-3 ms-2 text-sm font-medium">Web Development</label>
            </div>
        </li>
        <li class="w-full border-b sm:border-b-0 sm:border-r ">
            <div class="flex items-center ps-3">
                ...
                <label for="angular-checkbox-list" class="w-full py-3 ms-2 text-sm font-medium ">Social Media Graphics</label>
            </div>
        </li>
      </ul>
    </div>
